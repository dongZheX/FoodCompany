...
public class ProducePlanFrame extends JFrame implements ActionListener{
	...
	//button
	private JButton selectPickUp_btn,selectWarehouse_btn,selectProducePlan_btn,selectOrdered_btn,selectCus_btn,selectGood_btn,selectBill_btn;
	...
	public ProducePlanFrame(Administrators adm) {
		...
		selectBill_btn = new JButton("查询账单");
		...
		selectBill_btn.addActionListener(this);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		else if(btn_name.equals("查询账单")){
			selectDesktop.add(new SelectBillFrame());
		}
